...
There are many columns out of which will be used as features. Commnonly we have object, float and date-month-year datatypes.
...
'first_intevestment_at’, ‘last_investment_at’, ‘ROI’, ‘invested_companies’ and `investment_rounds' were deleted.    
